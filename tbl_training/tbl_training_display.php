...
if ((isset($_GET['del']))) {
  ...
  $query = "DELETE FROM tbl_training WHERE trainingBatchNo=$trainingBatchNo";
      ...
      <table class="table table-hover my-3 py-3"  id="datatable">
        ...
        while($rows=mysqli_fetch_array($result)){
            ...
            <tr>
                ...
                <td><?php echo $rows['trainingHeading'];?></td>
                <td><?php echo $rows['skill'];?></td>
                <td><?php echo $rows['remark'];?></td>
                <td><?php echo $rows['syllabus'];?></td>
                <td><?php echo $rows['startsform'];?></td>
                <td>
                    <a href="<?php $_SERVER['PHP_SELF'] ?>?del='<?php echo $rows['trainingBatchNo']?>'" class="btn btn-sm btn-danger">Delete</a>
                  </td>
                  <td>
                  <a href="tbl_training_update.php?upd='<?php echo $rows['trainingBatchNo']?>'" 
...
<?php
    ...
    for($i=1;$i<=$total_page;$i++)
    {
        ...
        <li class="page-item" ><?php  echo "<a  class='page-link' aria-label='Previous' href='tbl_training_display.php?page=".$i."' >".$i."</a>";?>
        </li>
        <?php
